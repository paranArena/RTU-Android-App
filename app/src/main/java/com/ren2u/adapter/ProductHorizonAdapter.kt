...
class ProductHorizonAdapter internal constructor(var productList: List<ProductDetail>)
    : RecyclerView.Adapter<ProductHorizonAdapter.ListViewHolder>() {
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(_list: ProductDetail) {
            ...
            itemView.findViewById<TextView>(R.id.iv_number).text = "남은수량 $left / $max"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        return ListViewHolder(
            ...
            LayoutInflater.from(parent.context).inflate(R.layout.product_list_horizon, parent, false)
        )
    }
