...
class ManageCouponListAdapter internal constructor(var couponList: List<CouponListModel>)
    : RecyclerView.Adapter<ManageCouponListAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        return ListViewHolder(
            ...
            LayoutInflater.from(parent.context).inflate(R.layout.manage_coupon_list, parent, false)
        )
    }
